...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.916.2"><img src="https://img.shields.io/badge/latest_release-26.916.2-f3f0e8?style=flat-square&labelColor=20211f" alt="Latest GitHub Release 26.916.2"></a>
...
<p align="center">
  <a href="https://github.com/MilkSU-Official/milksu/releases/tag/v26.916.2">下载 26.916.2</a>
  ·
...
当前安装包是 **[26.916.2](https://github.com/MilkSU-Official/milksu/releases/tag/v26.916.2)**：macOS ARM64 DMG（Developer ID 签名并公证）、Windows x64 EXE、Linux x64 `.deb` 与 `.tar.gz`。Windows 安装器尚未代码签名，可能被 SmartScreen 拦住。已登录后可从侧栏下载本机更新。
...
```bash
# Ubuntu / Debian
sudo apt install ./MilkSU-Linux-x64-26.916.2.deb
